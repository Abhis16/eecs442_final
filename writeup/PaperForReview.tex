...
%We also noted that our dataset and the test videos primarily used ping pong balls that were white or light in color, and attempted to implement a weaker version of color filtering.
...
more details are discussed in %TODO:results
...
\begin{figure}[h]
  \centering
    \subfloat[\centering label 1]{{\includegraphics[width=5cm]{sideview2} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=5cm]{sideview.png} }}%
